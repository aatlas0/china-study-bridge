        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/studyinasia.ma/" target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary rounded-lg hover:bg-primary hover:text-primary-foreground transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18.77 7.46H14.5v-1.9c0-.9.6-1.1 1-1.1h3V.5h-4.33C10.24.5 9.5 3.44 9.5 5.32v2.15h-3v4h3v12h5v-12h3.85l.42-4z" /></svg>
              </a>
              <a href="https://www.instagram.com/study_in_asia.ma/" target="_blank" rel="noopener noreferrer" className="p-2 bg-secondary rounded-lg hover:bg-primary hover:text-primary-foreground transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>studyinasia05@gmail.com</span>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li>Lundi - Vendredi: 10h00 - 17h00</li>
